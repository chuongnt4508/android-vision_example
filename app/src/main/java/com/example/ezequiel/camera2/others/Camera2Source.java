...
public class Camera2Source {
    ...
    public void recordVideo(VideoStartCallback videoStartCallback, VideoStopCallback videoStopCallback, VideoErrorCallback videoErrorCallback) {
        try {
            ...
            new File(Environment.getExternalStorageDirectory() + "/" + Environment.DIRECTORY_MOVIES).mkdirs();
            videoFile = Environment.getExternalStorageDirectory() + "/" + Environment.DIRECTORY_MOVIES + "/" + formatter.format(new Date()) + ".mp4";
